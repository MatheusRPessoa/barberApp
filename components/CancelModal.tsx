...
const styles = StyleSheet.create({
    ...
    sheet: { backgroundColor: C.bgSurface, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 24, paddingBottom: 40, maxHeight: '85%' },
    ...
    input: { borderWidth: 1, borderColor: C.border, borderRadius: 8, padding: 12, minHeight: 70, textAlignVertical: 'top', fontSize: 14, color: C.textPrimary, marginTop: 8 },
